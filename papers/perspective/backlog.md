...
- [ ] **S2-2 to SUPPORTED**: Jaakkola 2020 is read and cited (2026-09-26), a gap statement for conceptual papers. It needs one more peer-reviewed gap statement for a named type (theoretical, design-science or perspective). Gregor & Hevner 2013 is unobtainable here, so look for another.
