...
- **Prose-heavy** — `README.md`, `docs/METHODOLOGY.md`, `docs/framework-summary.md`, decision records, audits.
...
- (-) Designed for software; less idiomatic for prose, methodology, audits.
...
The repo is overwhelmingly prose: methodology, templates as markdown patterns, DRs, audits, manuscripts. The bash snippets are short enough to fall under fair use / quotation in any normal adoption context. The future `tools/` directory is anticipated but its volume is uncertain — if it grows substantially, a dual-licence transition (Option D) is straightforward and revisitable per the trigger conditions below.
...
- README's "Templates" and "Audits" sections gain implicit permission to be quoted and adapted with attribution.
