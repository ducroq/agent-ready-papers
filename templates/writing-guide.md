...
### Empirical Paper Supplement (DR-008)

<!-- Skip this section for non-empirical papers (reviews, position papers, frameworks). -->

#### Data & Reproducibility
- [ ] All datasets referenced with file paths or repository links
- [ ] Analysis scripts identified (language, version, key libraries)
- [ ] Data processing pipeline documented (raw → cleaned → analyzed)
- [ ] Data availability statement drafted (open access, on request, or restricted)

#### Statistical Completeness
- [ ] Test statistics reported with degrees of freedom (e.g., t(14) = 2.31)
- [ ] Sample sizes stated for all comparisons
- [ ] Multiple comparison corrections applied and named (e.g., Bonferroni, Holm)
- [ ] Effect sizes reported alongside p-values
- [ ] Null results reported, not just significant findings

#### Measurement & Equipment
- [ ] Equipment identified by manufacturer, model, and serial number (where relevant)
- [ ] Calibration status and date documented
- [ ] Uncertainty budgets calculated per applicable standard (e.g., GUM)
- [ ] Methodology references cited (ISO, ASTM, or equivalent)

#### Figures & Tables
- [ ] All figures traceable to specific data files and analysis scripts
- [ ] Figure resolution and format meet journal requirements
- [ ] Tables include units, sample sizes, and statistical annotations
- [ ] Supplementary material prepared for data that supports but doesn't fit the main text

#### Empirical Claim Verification
- [ ] Own-data claims linked to data file paths in the registry
- [ ] Pending-data claims marked with lifecycle stage (see claim-registry "Claim Lifecycle")
- [ ] Methodological facts assessed as ESTABLISHED where applicable (see claim-registry "Methodological Facts")
- [ ] Single-sample or small-N limitations noted in Discussion
