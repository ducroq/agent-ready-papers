...
**Current release:** v4.0.0 (2026-09-26) — see [`CHANGELOG.md`](CHANGELOG.md). Pin your project with `agent-ready-papers: v4.0.0` in your CLAUDE.md and surface drift at session start; [`templates/CLAUDE.md`](templates/CLAUDE.md) now carries that line for you.
