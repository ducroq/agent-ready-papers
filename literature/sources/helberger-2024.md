# Helberger 2024 — FutureNewsCorp (L49)

**Reading status:** READ 2026-05-27 (notes captured in ovr.news `docs/LANDSCAPE.md` academic cluster + session chat). Re-read for citable specifics in Phase 2.
...
- The provider/deployer asymmetry, stated precisely enough to cite → **S2-1** (P0).
- The in-house-AI disincentive for small media → frames why ovr.news's *open-build* move is significant (governance hook, not just engineering).
