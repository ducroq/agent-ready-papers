...
- Nucleus/satellite distinction captures importance hierarchy
- Relations like Evidence, Justify, Elaboration directly map to academic argument structure
- The only framework that decomposes an entire document into relational structure
- Most mature computational ecosystem: parsers, annotated corpora, benchmarks
- eRST (Zeldes et al. 2025) extends to graph structures and cross-section relations
