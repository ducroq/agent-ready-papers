...
**Current release:** v1.3.0 (2026-06-01) — see [`CHANGELOG.md`](CHANGELOG.md). Pin your project with `agent-ready-papers: v1.3.0` in your CLAUDE.md and surface drift at session start.
