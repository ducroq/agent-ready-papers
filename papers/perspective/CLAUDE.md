...
| Adding or verifying literature sources | `../../literature/README.md` — indexed sources by topic |
...
- Anti-hallucination checklist: 14/14 references pass (2026-09-26: +12 sources for S1-1/S1-2/S1-4/S2-2, each Crossref/arXiv-verified and read in full; VANRA is a web source)
...
- Added S1-5: calculation verification as failure mode
